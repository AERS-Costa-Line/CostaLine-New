...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Servicio Ejecutivo: CDMX a Acapulco Diamante | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="Experimenta el máximo confort en nuestra ruta ejecutiva a Acapulco Diamante. Asientos reclinables, más espacio y atención personalizada. Compra tu boleto ahora." />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Servicio de Autobús Ejecutivo: CDMX a Acapulco Diamante",
  "description": "Viaja con el máximo confort en la ruta ejecutiva de Costa Line a Acapulco Diamante. Disfruta de beneficios premium y atención de primer nivel.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/ejecutivos/cdmx-a-acapulco-diamante",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-eje-cdmx-a-acapulco-diamante></page-eje-cdmx-a-acapulco-diamante>
		</main>
