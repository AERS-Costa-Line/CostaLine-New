...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Servicio Ejecutivo: Chilpancingo a Acapulco | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Viaje rápido a Acapulco? Disfruta el confort del servicio ejecutivo desde Chilpancingo. Asientos reclinables, más espacio y un viaje de lujo. ¡Compra tu boleto ahora!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Servicio de Autobús Ejecutivo: Chilpancingo a Acapulco",
  "description": "Viaja de Chilpancingo a Acapulco con la máxima comodidad y rapidez en el servicio ejecutivo de Costa Line. Una experiencia de viaje superior.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/ejecutivos/chilpancingo-a-acapulco",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-eje-chilpancingo-a-acapulco></page-eje-chilpancingo-a-acapulco>
		</main>
