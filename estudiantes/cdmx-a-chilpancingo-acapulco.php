...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Tarifa Estudiante: Chilpancingo y Acapulco | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Estudiante? ¡Paga menos en tu viaje a Chilpancingo o Acapulco! Sal desde CDMX (Taxqueña), presenta tu credencial vigente y aprovecha tu tarifa. ¡Reserva tu viaje ahora!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viajes a Chilpancingo y Acapulco con Tarifa de Estudiante",
  "description": "Tarifa especial para estudiantes en las rutas desde CDMX (Terminal Sur) a Chilpancingo y Acapulco.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/estudiantes/cdmx-a-chilpancingo-acapulco",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-cdmx-a-chilpancingo-acapulco></page-cdmx-a-chilpancingo-acapulco>
		</main>
