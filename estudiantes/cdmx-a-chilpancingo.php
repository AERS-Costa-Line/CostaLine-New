...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Tarifa de Estudiante: Chilpancingo | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Viajas a Chilpancingo y eres estudiante? ¡Paga menos! Sal desde CDMX (Taxqueña), presenta tu credencial vigente y aprovecha tu tarifa especial. ¡Reserva ahora!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje en autobús a Chilpancingo con Tarifa de Estudiante",
  "description": "Tarifa especial para estudiantes en la ruta CDMX (Terminal Sur) a Chilpancingo.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/estudiantes/cdmx-a-chilpancingo",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-cdmx-a-chilpancingo></page-cdmx-a-chilpancingo>
		</main>
