...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Tarifa de Estudiante: Iguala, Gro. | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Viajas a Iguala y eres estudiante? ¡Paga menos! Sal desde CDMX (Taxqueña), presenta tu credencial vigente y aprovecha tu tarifa. ¡Reserva tu boleto ahora!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje en autobús a Iguala con Tarifa de Estudiante",
  "description": "Tarifa especial para estudiantes en la ruta CDMX (Terminal Sur) a Iguala, Guerrero.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/estudiantes/cdmx-a-iguala",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-cdmx-a-iguala></page-cdmx-a-iguala>
		</main>
