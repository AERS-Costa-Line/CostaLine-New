...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Tarifa de Estudiante: Acapulco Papagayo | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Eres estudiante? ¡Paga menos en tu viaje a Acapulco Papagayo (Costera)! Presenta tu credencial vigente y aprovecha tu tarifa especial. ¡Reserva tu viaje a la playa!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje en autobús a Acapulco Papagayo con Tarifa de Estudiante",
  "description": "Tarifa especial para estudiantes en la ruta CDMX a Acapulco Papagayo (Costera).",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/estudiantes/cdmx-a-acapulco-papagayo",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-cdmx-a-acapulco-papagayo></page-cdmx-a-acapulco-papagayo>
		</main>
