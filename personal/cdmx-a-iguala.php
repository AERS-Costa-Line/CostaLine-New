...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Viaja de CDMX a Iguala, Gro. | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Vas a Iguala? Salidas desde la Terminal del Sur (Taxqueña) en CDMX. Consulta horarios y compra tu boleto de autobús en línea, fácil y seguro. ¡Reserva tu viaje hoy!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje en Autobús de CDMX a Iguala",
  "description": "Viaja cómodamente desde la Terminal del Sur (Taxqueña) de la Ciudad de México a Iguala, Guerrero, con Costa Line.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/personal/cdmx-a-iguala",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-pers-cdmx-a-iguala></page-pers-cdmx-a-iguala>
		</main>
