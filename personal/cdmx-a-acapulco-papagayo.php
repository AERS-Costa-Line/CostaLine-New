...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Viaja de CDMX a Acapulco Papagayo | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Listo para la Costera? Viaja a Acapulco Papagayo desde CDMX (Terminal Sur). Consulta horarios y compra tu boleto en línea de forma fácil y segura. ¡Reserva ahora!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje en Autobús de CDMX a Acapulco Papagayo (Costera)",
  "description": "Viaja cómodamente desde la Terminal del Sur (Taxqueña) de la Ciudad de México a la Terminal Papagayo en la Costera de Acapulco con Costa Line.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/personal/cdmx-a-acapulco-papagayo",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-pers-cdmx-a-acapulco-papagayo></page-pers-cdmx-a-acapulco-papagayo>
		</main>
