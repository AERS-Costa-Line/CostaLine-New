...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Viaja de Chilpancingo a Acapulco | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Necesitas un viaje rápido a Acapulco? Salidas frecuentes desde Chilpancingo. Consulta horarios y compra tu boleto de autobús en línea, fácil y seguro. ¡Reserva ya!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje en Autobús de Chilpancingo a Acapulco",
  "description": "Viaja de forma rápida y cómoda desde Chilpancingo a Acapulco con Costa Line. Compra tu boleto en línea y asegura tu asiento.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/personal/chilpancingo-a-acapulco",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-pers-chilpancingo-a-acapulco></page-pers-chilpancingo-a-acapulco>
		</main>
