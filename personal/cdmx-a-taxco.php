...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Viaja de CDMX a Taxco, Gro. | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Escapada al Pueblo Mágico de Taxco? Salidas desde CDMX (Terminal Sur). Consulta horarios y compra tu boleto de autobús en línea, fácil y seguro. ¡Reserva tu viaje hoy!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje en Autobús de CDMX a Taxco, Guerrero",
  "description": "Viaja cómodamente desde la Terminal del Sur (Taxqueña) de la Ciudad de México al Pueblo Mágico de Taxco con Costa Line.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/personal/cdmx-a-taxco",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-pers-cdmx-a-taxco></page-pers-cdmx-a-taxco>
		</main>
