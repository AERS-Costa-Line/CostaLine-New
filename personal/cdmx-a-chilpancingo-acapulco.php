...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Viaja a Chilpancingo y Acapulco desde CDMX | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Vas a Guerrero? Elige tu destino: Chilpancingo o Acapulco. Salidas desde CDMX (Terminal Sur). Consulta horarios y compra tu boleto en línea fácil y seguro. ¡Reserva ahora!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viajes en Autobús de CDMX a Chilpancingo y Acapulco",
  "description": "Viaja cómodamente desde la Terminal del Sur (Taxqueña) de la Ciudad de México a Chilpancingo o a las terminales de Acapulco con Costa Line.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/personal/cdmx-a-chilpancingo-acapulco",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
