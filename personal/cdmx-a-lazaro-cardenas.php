...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Viaja de CDMX a Lázaro Cárdenas | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Necesitas viajar a Lázaro Cárdenas? Salidas desde CDMX (Terminal Poniente). Consulta horarios y compra tu boleto de autobús en línea, fácil y seguro. ¡Reserva tu viaje hoy!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje en Autobús de CDMX a Lázaro Cárdenas, Michoacán",
  "description": "Viaja cómodamente desde la Terminal de Poniente (Observatorio) de la Ciudad de México a Lázaro Cárdenas, Michoacán, con Costa Line.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/personal/cdmx-a-lazaro-cardenas",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-pers-cdmx-a-lazaro-cardenas></page-pers-cdmx-a-lazaro-cardenas>
		</main>
