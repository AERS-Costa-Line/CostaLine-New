...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Ruta Chilpancingo a Acapulco | Compra tu Boleto | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="Conoce la ruta más rápida de Chilpancingo a Acapulco. Salidas frecuentes. Consulta horarios, precios y compra tu boleto de autobús en línea. ¡Viaja en minutos!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Ruta de Autobús de Chilpancingo a Acapulco",
  "description": "Información y compra de boletos para la ruta de alta frecuencia de Costa Line entre Chilpancingo y Acapulco.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/rutas/chilpancingo-a-acapulco",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-ruta-chilpancingo-a-acapulco></page-ruta-chilpancingo-a-acapulco>
		</main>
