...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Ruta CDMX a Iguala, Gro. | Compra tu Boleto | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Vas a Iguala? Conoce la ruta desde la Terminal del Sur (Taxqueña) en CDMX. Consulta horarios y compra tu boleto de autobús en línea, fácil y seguro. ¡Reserva tu viaje hoy!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Ruta de Autobús de CDMX a Iguala",
  "description": "Información y compra de boletos para la ruta directa de Costa Line desde la Ciudad de México (Terminal Sur) a Iguala, Guerrero.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "arrivalBusStop": {
    "@type": "BusStation",
    "name": "Terminal de Autobuses de Iguala"
  },
  "offers": {
    "@type": "Offer",
    "priceCurrency": "MXN",
    "availability": "https://schema.org/InStock",
    "url": "https://www.costaline.com.mx/rutas/cdmx-a-iguala",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-ruta-cdmx-a-iguala></page-ruta-cdmx-a-iguala>
		</main>
