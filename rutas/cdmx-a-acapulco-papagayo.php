...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Ruta CDMX a Acapulco Papagayo | Compra tu Boleto | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="Conoce la ruta directa a Acapulco Papagayo (Costera) desde la Terminal del Sur (Taxqueña) de CDMX. Consulta horarios, precios y compra tu boleto en línea fácil y seguro. ¡Viaja hoy!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje en Autobús en la Ruta CDMX - Acapulco Papagayo",
  "description": "Información y compra de boletos para la ruta directa de Costa Line desde la Ciudad de México (Terminal Sur) a la Terminal Papagayo en la Costera de Acapulco.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "arrivalBusStop": {
    "@type": "BusStation",
    "name": "Terminal Acapulco Papagayo (Costera)"
  },
  "offers": {
    "@type": "Offer",
    "priceCurrency": "MXN",
    "availability": "https://schema.org/InStock",
    "url": "https://www.costaline.com.mx/rutas/cdmx-a-acapulco-papagayo",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-ruta-cdmx-a-acapulco-papagayo></page-ruta-cdmx-a-acapulco-papagayo>
		</main>
