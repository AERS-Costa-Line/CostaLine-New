...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Ruta CDMX a Acapulco Diamante | Compra tu Boleto | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="Descubre la ruta directa a Acapulco Diamante desde la Terminal del Sur (Taxqueña) de CDMX. Consulta horarios, precios y compra tu boleto en línea fácil y seguro. ¡Viaja hoy!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje en Autobús en la Ruta CDMX - Acapulco Diamante",
  "description": "Información y compra de boletos para la ruta directa de Costa Line desde la Ciudad de México (Terminal Sur) a la zona Diamante de Acapulco.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "arrivalBusStop": {
    "@type": "BusStation",
    "name": "Terminal Acapulco Diamante"
  },
  "offers": {
    "@type": "Offer",
    "priceCurrency": "MXN",
    "availability": "https://schema.org/InStock",
    "url": "https://www.costaline.com.mx/rutas/cdmx-a-acapulco-diamante",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-ruta-cdmx-a-acapulco-diamante></page-ruta-cdmx-a-acapulco-diamante>
		</main>
