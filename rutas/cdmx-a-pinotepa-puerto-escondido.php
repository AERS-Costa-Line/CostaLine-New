...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Ruta a Puerto Escondido (vía Pinotepa) | Compra tu Boleto</title>

		<!-- Meta Description -->
		<meta name="description" content="Conoce la ruta a Puerto Escondido, con parada en Pinotepa, saliendo de CDMX (Terminal Sur). Consulta horarios, precios y compra tu boleto a la costa de Oaxaca. ¡Reserva hoy!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Ruta de Autobús de CDMX a Puerto Escondido (vía Pinotepa)",
  "description": "Información y compra de boletos para la ruta directa de Costa Line desde la Ciudad de México (Terminal Sur) a Pinotepa Nacional y Puerto Escondido, Oaxaca.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/rutas/cdmx-a-pinotepa-puerto-escondido",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
