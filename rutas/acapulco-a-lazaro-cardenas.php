...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Ruta Acapulco a Lázaro Cárdenas | Compra tu Boleto | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="Conoce la ruta directa de Costa Line de Acapulco a Lázaro Cárdenas. Consulta horarios, precios y compra tu boleto de autobús en línea de forma fácil y segura. ¡Viaja hoy!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje en Autobús en la Ruta Acapulco - Lázaro Cárdenas",
  "description": "Información y compra de boletos para la ruta directa de Costa Line entre Acapulco, Guerrero, y Lázaro Cárdenas, Michoacán.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/rutas/acapulco-a-lazaro-cardenas",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
