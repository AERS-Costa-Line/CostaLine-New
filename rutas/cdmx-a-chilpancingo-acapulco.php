...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Rutas a Chilpancingo y Acapulco desde CDMX | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="Explora las rutas a Chilpancingo y Acapulco desde la Terminal Sur de CDMX. Consulta todos los horarios y precios. ¡Compra tu boleto fácil y viaja hoy mismo!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Rutas de Autobús de CDMX a Chilpancingo y Acapulco",
  "description": "Información y compra de boletos para las rutas directas de Costa Line desde la Ciudad de México (Terminal Sur) a Chilpancingo y Acapulco.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "arrivalBusStop": [
    {
      "@type": "BusStation",
      "name": "Terminal de Autobuses de Chilpancingo"
    },
    {
      "@type": "BusStation",
      "name": "Terminal de Autobuses de Acapulco (Costera)"
    },
    {
      "@type": "BusStation",
      "name": "Terminal de Autobuses de Acapulco (Diamante)"
    }
  ],
  "offers": {
    "@type": "Offer",
    ...
    "url": "https://www.costaline.com.mx/rutas/cdmx-a-chilpancingo-acapulco",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-ruta-cdmx-a-chilpancingo-acapulco></page-ruta-cdmx-a-chilpancingo-acapulco>
		</main>
