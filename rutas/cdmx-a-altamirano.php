...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Ruta CDMX a Ciudad Altamirano | Compra tu Boleto | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="Conoce la ruta directa a Ciudad Altamirano desde CDMX (Terminal Poniente). Consulta horarios, precios y compra tu boleto en línea fácil y seguro. ¡Viaja hoy!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje en Autobús en la Ruta CDMX - Ciudad Altamirano",
  "description": "Información y compra de boletos para la ruta directa de Costa Line desde la Ciudad de México (Terminal Poniente) a Ciudad Altamirano, Guerrero.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "arrivalBusStop": {
    "@type": "BusStation",
    "name": "Terminal de Autobuses de Ciudad Altamirano"
  },
  "offers": {
    "@type": "Offer",
    "priceCurrency": "MXN",
    "availability": "https://schema.org/InStock",
    "url": "https://www.costaline.com.mx/rutas/cdmx-a-altamirano",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-ruta-cdmx-a-altamirano></page-ruta-cdmx-a-altamirano>
		</main>
