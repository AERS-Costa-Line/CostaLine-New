        ...
        this.innerHTML = `
            <header aria-label="Encabezado Costa Line">
                ...
                <nav aria-label="Menú principal">
                    <!-- ... Tu menú de navegación va aquí sin cambios ... -->
                </nav>
                ...
                <!-- ***** CAMBIO #1: Añadido style="visibility: hidden;" para evitar el flicker ***** -->
                <button id="openDotersModal" class="btn btn-doters desktop-doters" aria-label="Iniciar sesión Doters" style="visibility: hidden;"></button>
                ...
                <div id="dropdown-menu">
                    <ul>
                        <!-- ... Tu menú desplegable va aquí sin cambios ... -->
                        <li class="li__login">
                            ...
                            <!-- ***** CAMBIO #2: Añadido style="visibility: hidden;" al botón móvil ***** -->
                            <button id="openDotersModalMovil" class="btn-doters" aria-label="Iniciar sesión Doters" style="visibility: hidden;"></button>
                        </li>
                    </ul>
                </div>
            </header>
