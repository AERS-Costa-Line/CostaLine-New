document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!loginModal || !profileModal || !loginForm) {
    console.error(
      "No se encontraron los elementos esenciales del modal. El script no se ejecutará.",
    );
    return;
  }
  ...
  function renderLoggedOutState() {
    if (loginIconDesktop) {
      loginIconDesktop.innerHTML = `<a href="#" class="open-login-modal-link"><img src="../../../../src/assets/img/logos/logo-monedero-electronico.webp" alt="Iniciar sesión en Monedero Electrónico" title="Ingresa a Monedero Electrónico" width="1692" height="602" style="cursor: pointer;"></a>`;
    }
