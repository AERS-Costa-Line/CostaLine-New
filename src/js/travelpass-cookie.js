	...
	function updateLoginIcon(profileData) {
		...
		if (loginIconDesktop) {
			loginIconDesktop.innerHTML = profileData
				? `<a href="#" id="open-profile-modal-link" class="nombre-monedero"><img src="../../src/assets/img/logos/logo-monedero-electronico.webp" class="icono-travel" alt="Monedero Electrónico" title="Perfil Monedero Electrónico"> Hola, ${profileData.name}</a>`
