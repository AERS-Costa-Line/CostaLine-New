...
class PageTolucaEnglish extends HTMLElement {
...
<section class="hero">
  <div class="hero__content">
    <h1 class="hero__title">Buses to Toluca with Costaline</h1>
    <p class="hero__subtitle">Travel to the capital of the State of Mexico and discover a modern, cultural city full of tradition.</p>
  </div>
</section>
...
<section class="features">
  <div class="container">
    <h2 class="section-title">Why travel with Costaline to Toluca?</h2>
    ...
    <div class="features__grid">
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">Air-conditioned units, good space, and reclining seats for a comfortable trip.</p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">Travel to the capital of Mexico State without overspending. Competitive fares every day.</p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">Professional drivers and buses that meet strict safety standards.</p>
      </div>
      ...
      <div class="feature-card">
        ...
        <h3 class="feature-card__title">Cultural destination</h3>
        <p class="feature-card__description">Tours, museums, local cuisine, and the unique atmosphere of the Toluca Valley.</p>
      </div>
...
<section class="route-info">
  <div class="container route-info__container">
    <h2 class="section-title">Featured Route: Mexico City → Toluca</h2>
    ...
    <div class="route-info__card">
      ...
      <div class="route-info__timeline">
        ...
        <div class="route-info__stops">
          <div class="route-info__stop">
            ...
            <span class="route-info__stop-name">Mexico City (Terminal Poniente)</span>
          </div>

          <div class="route-info__stop">
            <span class="route-info__stop-name">Toluca (Bus Terminal)</span>
            <div class="route-info__stop-icon">
      ...
      <div class="route-info__details-grid">
        <div class="detail-item">
          ...
          <p class="detail-item__value">1 h 30 min – 2 h 00 min</p>
        </div>
        ...
        <div class="detail-item">
          ...
          <p class="detail-item__value">Economy / First / Plus</p>
        </div>
      </div>
...
<section class="attractions">
  <div class="container">
    <h2 class="section-title">Places to visit in Toluca</h2>
    ...
    <div class="attractions__grid">
      ...
      <div class="attraction-card">
        ...
        <div class="attraction-card__content">
          <h3 class="attraction-card__title">Cosmovitral Botanical Garden</h3>
        </div>
      </div>
    ...
    <div class="faq__list">
      ...
      <details class="faq-item">
        <summary class="faq-item__summary">
          <span class="faq-item__question">How much is the ticket to Toluca?</span>
          <span class="faq-item__icon">
            <span class="icon-arrow-down material-symbols-outlined"></span>
          </span>
        </summary>
        <p class="faq-item__answer">The fare varies depending on the schedule and bus type. You can check the exact price during purchase.</p>
      </details>

      <details class="faq-item">
        <summary class="faq-item__summary">
          <span class="faq-item__question">Which terminal do the buses depart from?</span>
          <span class="faq-item__icon">
            <span class="icon-arrow-down material-symbols-outlined"></span>
          </span>
        </summary>
        <p class="faq-item__answer">Departures are from the Terminal Poniente (Observatorio) in Mexico City.</p>
      </details>
      ...
      <details class="faq-item">
        ...
        <p class="faq-item__answer">Air conditioning, reclining seats, and trained drivers to provide a safe trip.</p>
      </details>
...
<section class="cta">
  <div class="container">
    <h2 class="cta__title">Travel to Toluca with Costaline</h2>
    <p class="cta__subtitle">Book your ticket and enjoy the capital of Mexico State with the best comfort and safety.</p>
    <a href="../destinations/bus-to-toluca.html" class="btn btn--primary btn--large" target="_blank" rel="noopener noreferrer">
...
customElements.define("page-toluca-english", PageTolucaEnglish);
