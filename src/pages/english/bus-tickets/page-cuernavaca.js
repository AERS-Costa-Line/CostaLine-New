...
class PageCuernavacaEnglish extends HTMLElement {
...
<section class="hero">
  <div class="hero__content">
    <h1 class="hero__title">Buses to Cuernavaca with Costaline</h1>
    <p class="hero__subtitle">Get to the capital of Morelos with a fast, comfortable, and safe trip. Costaline connects you from CDMX and other cities with modern, air-conditioned units.</p>
  </div>
</section>
...
<section class="features">
  <div class="container">
    <h2 class="section-title">Why travel with Costaline to Cuernavaca?</h2>
    ...
    <div class="features__grid">
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">Travel with reclining seats, air conditioning, and modern units that make your journey more pleasant.</p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">Competitive prices and exclusive discounts when buying your ticket online.</p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">Trained drivers and safety protocols that guarantee a reliable trip.</p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">Arrive in a city with direct access to tourist destinations like Tepoztlán, Xochicalco, and El Tepozteco.</p>
      </div>
...
<section class="route-info">
  <div class="container route-info__container">
    <h2 class="section-title">Featured Route: CDMX Taxqueña → Cuernavaca</h2>
    ...
    <div class="route-info__card">
      ...
      <div class="route-info__details-grid">
        ...
        <div class="detail-item">
          ...
          <p class="detail-item__value">Constant departures throughout the day</p>
        </div>

        <div class="detail-item">
          <p class="detail-item__label">Bus Type</p>
          <p class="detail-item__value">First / Plus Service</p>
        </div>
      </div>
...
<section class="attractions">
  <div class="container">
    <h2 class="section-title">Places to visit in Cuernavaca</h2>
    ...
    <div class="attractions__grid">
      ...
      <div class="attraction-card">
        ...
        <div class="attraction-card__content">
          <h3 class="attraction-card__title">Palace of Cortés</h3>
        </div>
      </div>
      ...
      <div class="attraction-card">
        ...
        <div class="attraction-card__content">
          <h3 class="attraction-card__title">Borda Garden</h3>
        </div>
      </div>
      ...
      <div class="attraction-card">
        ...
        <div class="attraction-card__content">
          <h3 class="attraction-card__title">Cuernavaca Cathedral</h3>
        </div>
      </div>
    ...
    <div class="faq__list">
      ...
      <details class="faq-item">
        <summary class="faq-item__summary">
          <span class="faq-item__question">How much is the ticket to Cuernavaca?</span>
          <span class="faq-item__icon">
            <span class="icon-arrow-down material-symbols-outlined"></span>
          </span>
        </summary>
        <p class="faq-item__answer">Prices vary depending on the season and point of origin. Check the updated cost when choosing your travel date.</p>
      </details>

      <details class="faq-item">
        <summary class="faq-item__summary">
          <span class="faq-item__question">What are the schedules to Cuernavaca?</span>
          <span class="faq-item__icon">
            <span class="icon-arrow-down material-symbols-outlined"></span>
          </span>
        </summary>
        <p class="faq-item__answer">We have frequent departures throughout the day from CDMX and other cities. Check the schedules when buying your ticket.</p>
      </details>
      ...
      <details class="faq-item">
        ...
        <p class="faq-item__answer">Air-conditioned buses, reclining seats, and experienced drivers for a safe and comfortable trip.</p>
      </details>
...
<section class="cta">
  <div class="container">
    <h2 class="cta__title">Travel to Cuernavaca with Costaline!</h2>
    <p class="cta__subtitle">Book your ticket today and enjoy a fast and safe trip to Morelos.</p>
    <a href="../destinations/bus-to-cuernavaca.html" class="btn btn--primary btn--large" target="_blank" rel="noopener noreferrer">
...
customElements.define("page-cuernavaca-english", PageCuernavacaEnglish);
