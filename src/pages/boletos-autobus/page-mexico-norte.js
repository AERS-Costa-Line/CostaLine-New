...
class PageMexicoNorte extends HTMLElement {
...
<section class="hero">
  <div class="hero__content">
    <h1 class="hero__title">Autobuses desde y hacia la Terminal de Autobuses México Norte con Costaline</h1>
    <p class="hero__subtitle">Viaja desde la Central del Norte de forma cómoda, segura y accesible. Conecta con CDMX, Estado de México y destinos clave con autobuses modernos y climatizados.</p>
  </div>
</section>
...
<section class="features">
  <div class="container">
    <h2 class="section-title">¿Por qué viajar desde México Norte con Costaline?</h2>
    <div class="features__grid">
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">Disfruta unidades modernas, asientos confortables y climatización para viajar con tranquilidad desde la Central del Norte.</p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">Consulta horarios y compra tus boletos en línea de forma rápida. Aprovecha precios competitivos según tu ruta y temporada.</p>
      </div>
      ...
      <div class="feature-card">
        ...
        <h3 class="feature-card__title">Seguridad en cada trayecto</h3>
        <p class="feature-card__description">Viaja con operadores capacitados y protocolos de seguridad para un traslado confiable desde CDMX.</p>
      </div>
      ...
      <div class="feature-card">
        ...
        <h3 class="feature-card__title">Ubicación estratégica</h3>
        <p class="feature-card__description">México Norte es una de las terminales más importantes de CDMX, con acceso rápido desde metro y transporte público.</p>
      </div>
...
<section class="route-info">
  <div class="container route-info__container">
    <h2 class="section-title">Ruta destacada: México Norte → Destinos Costaline</h2>
...
<section class="attractions">
  <div class="container">
    <h2 class="section-title">Terminal México Norte: lo que debes saber</h2>
    ...
    <div class="faq__list">
      <details class="faq-item">
        <summary class="faq-item__summary">
          <span class="faq-item__question">¿Cómo llegar a la Terminal México Norte?</span>
          <span class="faq-item__icon"><span class="icon-arrow-down material-symbols-outlined"></span></span>
        </summary>
        <p class="faq-item__answer">Puedes llegar fácilmente en metro, Metrobús, taxi o transporte público. La Central del Norte es una de las terminales mejor conectadas de CDMX.</p>
      </details>
      ...
      <details class="faq-item">
        <summary class="faq-item__summary">
          <span class="faq-item__question">¿Con cuánta anticipación debo llegar a México Norte?</span>
          <span class="faq-item__icon"><span class="icon-arrow-down material-symbols-outlined"></span></span>
        </summary>
...
<section class="cta">
  <div class="container">
    <h2 class="cta__title">¡Viaja desde México Norte con Costaline!</h2>
    <p class="cta__subtitle">Compra tus boletos en línea y disfruta un viaje cómodo, seguro y accesible desde la Central del Norte.</p>
    <a href="../destinos/autobus-a-mexico-norte.html" class="btn btn--primary btn--large" target="_blank" rel="noopener noreferrer">Ver más sobre el destino</a>
  </div>
</section>
...
customElements.define("page-mexico-norte", PageMexicoNorte);
