...
class PageMexicoPoniente extends HTMLElement {
...
<section class="hero">
  <div class="hero__content">
    <h1 class="hero__title">Autobuses desde y hacia la Terminal de Autobuses México Poniente (Observatorio) con Costaline</h1>
    <p class="hero__subtitle">Viaja desde Observatorio de forma cómoda, segura y accesible. Conecta con CDMX, Estado de México y destinos clave con autobuses modernos y climatizados.</p>
  </div>
</section>
...
<section class="features">
  <div class="container">
    <h2 class="section-title">¿Por qué viajar desde México Poniente (Observatorio) con Costaline?</h2>
    <div class="features__grid">
      ...
      <div class="feature-card">
        ...
        <h3 class="feature-card__title">Comodidad para tu traslado</h3>
        <p class="feature-card__description">Unidades modernas, asientos confortables y climatización para que tu viaje inicie con la mejor experiencia desde Observatorio.</p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">Consulta horarios y compra tus boletos en línea de forma rápida. Aprovecha tarifas competitivas según tu ruta y temporada.</p>
      </div>
      ...
      <div class="feature-card">
        ...
        <p class="feature-card__description">Operadores capacitados y protocolos de seguridad para que viajes con tranquilidad desde CDMX.</p>
      </div>
      ...
      <div class="feature-card">
        ...
        <h3 class="feature-card__title">Conectividad y ubicación</h3>
        <p class="feature-card__description">Observatorio es una terminal estratégica al poniente de la ciudad, con acceso práctico desde transporte público y vialidades principales.</p>
      </div>
...
<section class="route-info">
  <div class="container route-info__container">
    <h2 class="section-title">Ruta destacada: México Poniente (Observatorio) → Destinos Costaline</h2>
      ...
      <div class="route-info__timeline">
        ...
        <div class="route-info__stops">
          <div class="route-info__stop">
            ...
            <span class="route-info__stop-name">México Poniente</span>
          </div>
...
<section class="attractions">
  <div class="container">
    <h2 class="section-title">Terminal Observatorio: lo que debes saber</h2>
    ...
    <div class="attractions__grid">
      ...
      <div class="attraction-card">
        ...
        <div class="attraction-card__content">
          <h3 class="attraction-card__title">Acceso desde el poniente de CDMX</h3>
        </div>
      </div>
      ...
      <div class="attraction-card">
        ...
        <div class="attraction-card__content">
          <h3 class="attraction-card__title">Salas de espera y zona de abordaje</h3>
        </div>
      </div>
    ...
    <div class="faq__list">
      <details class="faq-item">
        <summary class="faq-item__summary">
          <span class="faq-item__question">¿Cómo llegar a la Terminal México Poniente (Observatorio)?</span>
          <span class="faq-item__icon"><span class="icon-arrow-down material-symbols-outlined"></span></span>
        </summary>
        <p class="faq-item__answer">Puedes llegar en transporte público, taxi o vehículo particular. Observatorio es una terminal ubicada al poniente de CDMX, con acceso práctico desde avenidas principales.</p>
      </details>
      ...
      <details class="faq-item">
        <summary class="faq-item__summary">
          <span class="faq-item__question">¿Con cuánta anticipación debo llegar a Observatorio?</span>
          <span class="faq-item__icon"><span class="icon-arrow-down material-symbols-outlined"></span></span>
        </summary>
        <p class="faq-item__answer">Te recomendamos llegar al menos 30 a 45 minutos antes de tu salida para abordar con calma y ubicar tu sala o andén.</p>
      </details>
    </div>
  </div>
</section>
...
<section class="cta">
  <div class="container">
    <h2 class="cta__title">¡Viaja desde México Poniente con Costaline!</h2>
    <p class="cta__subtitle">Compra tus boletos en línea y disfruta un viaje cómodo, seguro y accesible desde la Terminal Observatorio.</p>
    <a href="../destinos/autobus-a-mexico-poniente.html" class="btn btn--primary btn--large" target="_blank" rel="noopener noreferrer">Ver más sobre el destino</a>
  </div>
</section>
...
customElements.define("page-mexico-poniente", PageMexicoPoniente);
