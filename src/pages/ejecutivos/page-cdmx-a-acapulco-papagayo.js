...
class CdmxAacapulcoPapagayo extends HTMLElement {
    ...
    <p class="__paragraph">
        Acapulco Papagayo es un destino turístico popular que ofrece una variedad de actividades y lugares de interés. Entre los puntos destacados se encuentran: La Quebrada, famosa por sus clavadistas que realizan saltos impresionante; el Parque Papagayo, un extenso parque recreativo ideal para familias; playas como Caleta y Caletilla, perfectas para nadar; y su vibrante vida nocturna con una amplia oferta de bares y discotecas.
    </p>
...
customElements.define("page-eje-cdmx-a-acapulco-papagayo", CdmxAacapulcoPapagayo);
