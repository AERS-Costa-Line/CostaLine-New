...
class CdmxChilpancingoAcapulco extends HTMLElement {
    ...
    <p class="__paragraph">
        Chilpancingo, la capital del estado de Guerrero, ofrece una rica historia y cultura, con lugares como el Museo Regional de Guerrero y la Catedral de Santa María de la Asunción. Acapulco, por su parte, es famoso por sus playas paradisíacas, como la Playa Condesa y la Quebrada, donde se pueden ver los famosos clavadistas. Ambos destinos ofrecen una variedad de actividades para todos los gustos, desde explorar la historia local hasta disfrutar de la vibrante vida nocturna.
    </p>

    <p class="__subtitle__destinos">¿Por qué elegir Costaline para tu viaje?</p>
    <p class="__paragraph">
        Costaline se destaca por ofrecer un servicio de alta calidad en sus autobuses, garantizando un viaje cómodo y seguro. Sus unidades están equipadas con asientos reclinables, aire acondicionado y entretenimiento a bordo, lo que hace que el trayecto sea placentero. Además, la facilidad de compra de boletos en línea y la variedad de horarios disponibles hacen de Costaline una opción ideal para quienes buscan comodidad y eficiencia en su viaje.
    </p>
    ...
    <p class="__paragraph">Costaline ofrece descuentos especiales para estudiantes y personas mayores, por lo que es recomendable consultar las condiciones y presentar la documentación necesaria al momento de la compra.</p>
</section>
...
customElements.define("page-ruta-cdmx-a-chilpancingo-acapulco", CdmxChilpancingoAcapulco);
