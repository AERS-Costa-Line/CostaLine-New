...
class ChilpancingoAacapulco extends HTMLElement {
    ...
    <p class="__paragraph">
        Adquirir tus boletos de autobús a Chilpancingo - Acapulco con Costaline te garantiza un viaje cómodo y seguro. Sus autobuses están equipados con asientos reclinables, aire acondicionado y entretenimiento a bordo, asegurando una experiencia de viaje placentera. No esperes más y reserva tus boletos con Costaline para disfrutar de un servicio de calidad y llegar a tu destino con total confort.
    </p>
...
customElements.define("page-ruta-chilpancingo-a-acapulco", ChilpancingoAacapulco);
