...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Sol y Playa en Acapulco Papagayo | Viaje de Placer | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Listo para la escapada? Viaja a la Costera de Acapulco (Papagayo) desde CDMX. La arena, el mar y la fiesta te esperan. ¡Reserva fácil y que comiencen las vacaciones!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Escapada de Placer a Acapulco Papagayo (Costera)",
  "description": "Comienza tus vacaciones en la vibrante Costera de Acapulco. Viaja cómodamente desde CDMX y prepárate para disfrutar del sol, la playa y la diversión con Costa Line.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/placer/cdmx-a-acapulco-papagayo",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-placer-cdmx-a-acapulco-papagayo></page-placer-cdmx-a-acapulco-papagayo>
		</main>
