...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Descubre Chilpancingo: Viaje Cultural desde CDMX | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Buscas historia en Guerrero? Viaja a Chilpancingo desde CDMX (Taxqueña). Conoce la Cuna de la Bandera y sus tradiciones. ¡Reserva tu aventura cultural con Costa Line!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje Cultural de Placer: CDMX a Chilpancingo",
  "description": "Explora la rica historia y cultura de Chilpancingo, la Cuna de la Bandera Nacional. Viaja cómodamente desde CDMX (Terminal Sur) con Costa Line.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/placer/cdmx-a-chilpancingo",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-placer-cdmx-a-chilpancingo-acapulco></page-placer-cdmx-a-chilpancingo-acapulco>
		</main>
