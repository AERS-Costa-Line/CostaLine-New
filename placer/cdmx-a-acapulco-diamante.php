...
<html lang="es-MX">
	<head>
		...
		<!-- Title -->
		<title>Viaja de CDMX a Acapulco Diamante | Costa Line</title>

		<!-- Meta Description -->
		<meta name="description" content="¿Listo para la playa? Viaja directo a Acapulco Diamante desde la Terminal del Sur (Taxqueña) de CDMX. Consulta horarios y compra tu boleto en línea fácil y seguro. ¡Reserva ahora!" />
		...
		<script type="application/ld+json">
{
  ...
  "@type": "BusTrip",
  "name": "Viaje en Autobús de CDMX a Acapulco Diamante",
  "description": "Viaja cómodamente desde la Terminal del Sur (Taxqueña) de la Ciudad de México a la exclusiva zona de Acapulco Diamante con Costa Line.",
  "provider": {
    "@type": "Organization",
    "name": "Costa Line"
  },
  ...
  "offers": {
    ...
    "url": "https://www.costaline.com.mx/personal/cdmx-a-acapulco-diamante",
    "seller": {
      "@type": "Organization",
      "name": "Costa Line"
    }
...
<!-- End Google Tag Manager (noscript) -->
		...
		<main>
			<page-placer-cdmx-a-acapulco-diamante></page-placer-cdmx-a-acapulco-diamante>
		</main>
